...
export default function Home({data}) {
    ...
    return ( <> <div
        ...
        <div className="text-6xl font-sans  text-center mt-24 mb-4  font-semibold tracking-tighter lg:text-7xl text-gradient title-font">Pictures of the day</div>
        </div>

        <div className="flex-col flex items-center text-lg justify-items-center mx-auto p-6 rounded max-w-6xl">
            <p className="text-gray-500 max-w-3xl text-center mx-2 my-6 italic">"I want to know why the universe exist, why there is something greater than nothing."</p>
        ...
        data.map((item, index) => (
            <div
                ...
                <div
                    className={index % 2 == 0
                    ? "mx-5 rounded-lg flex-col lg:flex-row shadow-lg box-border flex items-stretch justify-center w-3/3 h-auto"
                    : "mx-5 mt-5 mb-2 rounded-lg flex-col lg:flex-row-reverse shadow-lg box-border flex items-stretch justify-center w-3/3"}>
                    <img
